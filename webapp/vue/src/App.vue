  ...
  computed: {
    ...
    chartLabels() {
      return this.searchUsername
        ? [`Сообщения ${this.searchUsername}`, 'Остальные сообщения']
        : ['Сообщения в чате'];
    },
    chartData() {
      return this.searchUsername
        ? [this.filteredMessages.length, this.totalMessages - this.filteredMessages.length]
        : [this.totalMessages];
    },
    chartColors() {
      return this.searchUsername ? ['#4CAF50', '#FFC107'] : ['#2196F3'];
    },
  },
  mounted() {
